...
* :class:`ELDAmwl.bases.factory.BaseOperationFactory` for selecting which algorithm to use.
* :class:`ELDAmwl.bases.factory.BaseOperation` containing the algorithm.

They represent a layered system, like a Russian doll.

:class:`ELDAmwl.bases.factory.BaseOperationFactory` is the outer
layer which is called by the surrounding code.
The only purpose of the descendants of this class is to
generate an instance of :class:`ELDAmwl.bases.factory.BaseOperation`
...
.. note::
    ...
    :class:`ELDAmwl.bases.factory.BaseOperation`. The instances of
    :class:`ELDAmwl.bases.factory.BaseOperationFactory` are just
    for making the choice among algorithms.

.. note::
    Instances of :class:`ELDAmwl.bases.factory.BaseOperation` must never
    addressed directly. Always call the :class:`ELDAmwl.bases.factory.BaseOperationFactory`.
