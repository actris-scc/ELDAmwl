...
#
# This file does only contain a selection of the most monte_carlo options. For a
...
sys.path.insert(0, os.path.abspath('../ELDAmwl'))
...
# kurzschreibweise für verweise in den code
default_role = 'py:obj'
...
latex_documents = [
    (master_doc, 'MWL.tex', 'MWL Documentation',
     'Ina Mattis', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'MWL', 'MWL Documentation',
     author, 'MWL', 'One line description of project.',
     'Miscellaneous'),
]
