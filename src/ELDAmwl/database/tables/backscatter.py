...
#    LowestHeight = Column(INTEGER, nullable=False, server_default=text("'-1'"))
#    TopHeight = Column(INTEGER, nullable=False, index=True, server_default=text("'-1'"))
#    WindowWidth = Column(INTEGER, nullable=False, index=True, server_default=text("'-1'"))
#    calValue = Column(INTEGER, nullable=False, index=True, server_default=text("'-1'"))
#    _calRangeSearchMethod_ID = Column(DECIMAL(10, 4), nullable=False, server_default=text("'0.0000'"))
    ...
    _calRangeSearchMethod_ID = Column(INTEGER, nullable=False, server_default=text("'-1'"))
...
class ElastBackscatterOption(Base):
    ...
    _elast_bsc_method_ID = Column(INTEGER, nullable=False, index=True, server_default=text("'-1'"))
    _bsc_calibr_options_ID = Column(INTEGER, nullable=False, index=True, server_default=text("'-1'"))
    _error_method_ID = Column(INTEGER, nullable=False, index=True, server_default=text("'-1'"))
    _lr_input_method_id = Column(INTEGER, nullable=False, index=True, server_default=text("'-1'"))
    ...
    _iter_bsc_options_id = Column(INTEGER, nullable=False, index=True, server_default=text("'-1'"))
...
class RamanBackscatterOption(Base):
    ...
    ID = Column(INTEGER, primary_key=True)
    _product_ID = Column(INTEGER, nullable=False, server_default=text("'-1'"))
    _ram_bsc_method_ID = Column(INTEGER, nullable=False, index=True, server_default=text("'-1'"))
    _bsc_calibr_options_ID = Column(INTEGER, nullable=False, index=True, server_default=text("'-1'"))
    _error_method_ID = Column(INTEGER, nullable=False, index=True, server_default=text("'-1'"))
